  ...
  describe('MiddlewareFactory', () => {
    ...
    describe('getVndExtensions', () => {
      it('should return a list of valid Content-Types', () => {
        const middlewareFactory = new MiddlewareFactory({vndExtension: 'test-vendor', supportedVersions: ['1.0.0', '1.1.1', '2.0.0', '2.2.2']});
    ...
    describe('createMiddleware', () => {
      it('should create a middleware that uses opts.attachVersionKey', () => {
        const middlewareFactory = new MiddlewareFactory({vndExtension: 'test-vendor', supportedVersions: ['1.0.0', '1.1.1', '2.0.0', '2.2.2'], attachVersionKey: 'customKey'});
  ...
  describe('VersionManager', () => {
    describe('getFittingVersion', () => {
      it('should get the highest fitting version', () => {
        const versionManager = new VersionManager({supportedVersions: ['1.0.0', '1.2.5', '2.0.0', '2.0.1', '1.0.3', '1.2.4', '3.1.1', '2.6.5'], vndExtension: 'test-vendor'});
